...
ENTITY 	csb IS
	...
	clk1M : OUT std_logic;
	clk : IN std_logic;
	clk1M1 : OUT std_logic
	);
END csb;

-- Design Ports Information
-- clk1M	=>  Location: PIN_43,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk1M1	=>  Location: PIN_106,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- clk	=>  Location: PIN_23,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF csb IS
...
SIGNAL \inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M_INCLK_bus\ : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M_outclk\ : std_logic;
...
\inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M_INCLK_bus\ <= (vcc & vcc & vcc & \inst|altpll_component|auto_generated|wire_pll1_clk\(0));
...
\clk1M~output\ : cycloneive_io_obuf
...
-- pragma translate_on
PORT MAP (
	i => \inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M_outclk\,
	devoe => ww_devoe,
	o => ww_clk1M);

-- Location: IOOBUF_X34_Y20_N9
\clk1M1~output\ : cycloneive_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	open_drain_output => "false")
...
\inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M\ : cycloneive_clkctrl
-- pragma translate_off
GENERIC MAP (
...
-- pragma translate_on
PORT MAP (
	inclk => \inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M_INCLK_bus\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	outclk => \inst|altpll_component|auto_generated|wire_pll1_clk[0]~clkctrl_e_clk1M_outclk\);
